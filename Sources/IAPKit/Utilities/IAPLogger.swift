...
public struct IAPLogger: Sendable {
    /// 日志子系统
    private static let subsystem = "com.iapkit"
    
    /// 传统日志记录器
    private static let osLog = OSLog(subsystem: subsystem, category: "IAPKit")
    
    /// 现代日志记录器（iOS 14+/macOS 11+）
    @available(iOS 14.0, macOS 11.0, *)
    private static let logger = Logger(subsystem: subsystem, category: "IAPKit")
